...
static int otm1901a_dj_otp_bl_update_status(struct backlight_device *bl)
{
...
static const struct backlight_ops otm1901a_dj_otp_bl_ops = {
	.update_status = otm1901a_dj_otp_bl_update_status,
};

static struct backlight_device *
otm1901a_dj_otp_create_backlight(struct mipi_dsi_device *dsi)
{
	struct device *dev = &dsi->dev;
...
static int otm1901a_dj_otp_probe(struct mipi_dsi_device *dsi)
{
	...
	ctx->panel.backlight = otm1901a_dj_otp_create_backlight(dsi);
