...
static int otm1901a_dj_bl_update_status(struct backlight_device *bl)
{
...
static const struct backlight_ops otm1901a_dj_bl_ops = {
	.update_status = otm1901a_dj_bl_update_status,
};

static struct backlight_device *
otm1901a_dj_create_backlight(struct mipi_dsi_device *dsi)
{
	struct device *dev = &dsi->dev;
...
static int otm1901a_dj_probe(struct mipi_dsi_device *dsi)
{
	...
	ctx->panel.backlight = otm1901a_dj_create_backlight(dsi);
...
static void otm1901a_dj_remove(struct mipi_dsi_device *dsi)
{
