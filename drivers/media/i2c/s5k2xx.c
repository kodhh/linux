...
static const struct reg_sequence s5k3p3_mode_snapshot_regs[] = {
	{ 0x6028, 0x2000 },
	{ 0x602a, 0x2e26 },
	{ 0x6f12, 0x0103 },
	{ 0x6028, 0x4000 },
...
static const struct reg_sequence s5k3p3_mode_preview_regs[] = {
	{ 0x6028, 0x2000 },
	{ 0x602a, 0x2e26 },
	{ 0x6f12, 0x0103 },
	{ 0x6028, 0x4000 },
...
static const struct reg_sequence s5k3p3_mode_hfr60_regs[] = {
	{ 0x6028, 0x2000 },
	{ 0x602a, 0x2e26 },
	{ 0x6f12, 0x0103 },
	{ 0x6028, 0x4000 },
...
static const struct reg_sequence s5k3p3_mode_hfr90_regs[] = {
	{ 0x6028, 0x2000 },
	{ 0x602a, 0x2e26 },
	{ 0x6f12, 0x0103 },
	{ 0x6028, 0x4000 },
...
static const struct reg_sequence s5k3p3_mode_hfr120_regs[] = {
	{ 0x6028, 0x2000 },
	{ 0x602a, 0x2e26 },
	{ 0x6f12, 0x0103 },
	{ 0x6028, 0x4000 },
...
static const struct s5k2xx_mode s5k3p3_modes[] = {
	{
		.width = 4632,
		.height = 3480,
		.fps = 30,
		...
		.llp = 5148,
		.link_freq_index = S5K2XX_LINK_FREQ_720MHZ_INDEX,
		.regs = s5k3p3_mode_snapshot_regs,
		.num_regs = ARRAY_SIZE(s5k3p3_mode_snapshot_regs),
	}, {
		.width = 2316,
		.height = 1740,
		.fps = 30,
		...
		.llp = 5148,
		.link_freq_index = S5K2XX_LINK_FREQ_720MHZ_INDEX,
		.regs = s5k3p3_mode_preview_regs,
		.num_regs = ARRAY_SIZE(s5k3p3_mode_preview_regs),
	}, {
		.width = 2316,
		.height = 1740,
		.fps = 60,
		...
		.llp = 5298,
		.link_freq_index = S5K2XX_LINK_FREQ_720MHZ_INDEX,
		.regs = s5k3p3_mode_hfr60_regs,
		.num_regs = ARRAY_SIZE(s5k3p3_mode_hfr60_regs),
	}, {
		.width = 1152,
		.height = 870,
		.fps = 90,
		...
		.llp = 5148,
		.link_freq_index = S5K2XX_LINK_FREQ_720MHZ_INDEX,
		.regs = s5k3p3_mode_hfr90_regs,
		.num_regs = ARRAY_SIZE(s5k3p3_mode_hfr90_regs),
	}, {
		.width = 1152,
		.height = 870,
		.fps = 120,
		...
		.llp = 5148,
		.link_freq_index = S5K2XX_LINK_FREQ_720MHZ_INDEX,
		.regs = s5k3p3_mode_hfr120_regs,
		.num_regs = ARRAY_SIZE(s5k3p3_mode_hfr120_regs),
	}
};

static struct s5k2xx_data s5k3p3_data = {
	.model = "s5k3p3",
	.chip_id = 0x3103,
	.modes = s5k3p3_modes,
